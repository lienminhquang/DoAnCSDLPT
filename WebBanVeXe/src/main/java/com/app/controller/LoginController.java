...
public class LoginController {
	...
	public String login(HttpServletResponse response, Model model, @RequestParam(name="username") String username, @RequestParam(name="password") String password) {
		
		
		KhachHang a = (KhachHang)khachHangSer.kiemTraDangNhap(username, password);
